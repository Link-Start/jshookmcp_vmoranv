...
| `memory_list_regions` | 待补充中文：List all memory regions in a process with protection flags. If pid is omitted, the active browser renderer PID is auto-discovered from the current browser session. |
